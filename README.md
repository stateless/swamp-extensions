...
| `@stateless/review` | `2026.06.17.1` | [`review/`](review/) | [registry](https://swamp-club.com/extensions/@stateless/review) | Human-in-the-loop review canvas — curation grids, markdown editor+preview doc review, approve/revise/reject publish gates. |
