...
| `@stateless/llm-catalog` | `2026.06.22.1` | [`llm-catalog/`](llm-catalog/) | [registry](https://swamp-club.com/extensions/@stateless/llm-catalog) | Sourced, versioned knowledge base of LLM-ops knowledge (models, runtimes, providers, hardware, techniques + access-path recipes) — read to decide which model to run where, at what cost. |
