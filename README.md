...
| `@stateless/review` | `2026.06.12.9` | [`review/`](review/) | [registry](https://swamp-club.com/extensions/@stateless/review) | Human-in-the-loop review canvas — curation grids, markdown editor+preview doc review, approve/revise/reject publish gates. |
